...
from gemini_music_recommender import MusicRecommender
...
def analyze_image():
    ...
    try:
        ...
        context = data.get('context', 'Instagram Story Background Music Recommendation')
        ...
        recommendations = music_recommender.recommend_songs(
            caption, user_preferences, context, preferred_languages=language_preferences
        )
...
# Enhanced Results Page HTML with Reorganized Layout and Copyable Captions
RESULTS_PAGE_HTML = '''
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
        ...
        <div class="results-layout">
            <div class="left-section">
                ...
                <div class="analysis-section">
                    ...
                    <!-- MOVED: Dynamic Refinement Section - Now directly under analysis -->
                ...
                <div class="recommendations-grid" id="recommendationsGrid">
                    ...
                    <div class="song-card">
                        ...
                        <div class="suggested-caption">
                            <h5>
                                <span><i class="fas fa-quote-left"></i> Suggested Caption</span>
                                <button class="copy-btn" onclick="copyCaption(this, '{{ song.suggested_caption|e }}')">
    ...
    <script>
        ...
        async function copyCaption(button, caption) {
            try {
        ...
        function updateRecommendationsGrid(recommendations) {
            ...
            recommendations.recommendations.forEach(song => {
                const escapedCaption = song.suggested_caption ? song.suggested_caption.replace(/'/g, "\\'").replace(/"/g, '\\"') : '';
                ...
                html += `
                    <div class="song-card">
                        ...
                        <div class="suggested-caption">
                            <h5>
                                <span><i class="fas fa-quote-left"></i> Suggested Caption</span>
                                <button class="copy-btn" onclick="copyCaption(this, '${escapedCaption}')">
                                    <i class="fas fa-copy"></i>
                                    Copy
                                </button>
                            </h5>
...
if __name__ == '__main__':
    print(" Starting MusicVision AI with Enhanced UX...")
    ...
    print(" Copyable Captions: Enabled")
    ...
    print(" AI Captions: Enabled - Copyable suggested captions for each song")
    ...
    print(" Enhanced UX: Reorganized layout with copyable captions")
