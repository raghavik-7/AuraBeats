...
def health_check():
    ...
    return jsonify({
        'status': 'healthy',
        'message': 'Professional Image to Music Recommendation API with Language Preferences',
        'models': {
...
# Home Page HTML with Language Preferences
HOME_PAGE_HTML = '''
<!DOCTYPE html>
<html lang="en">
<head>
...
# Results Page HTML (updated to show language preferences)
RESULTS_PAGE_HTML = '''
<!DOCTYPE html>
<html lang="en">
<head>
...
if __name__ == '__main__':
    print(" Starting MusicVision AI with Language Preferences...")
